...
import bags1 from "../../../Assets/cheese.jpg";
import lady from "../../../Assets/cone.jdb.webp";
    ...
    <main>
      <section className="hero container my-3">
        ...
        <div className="hero-image">
          <div id="blob"></div>
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEgOZCwas4-hMMoBXwe0HrBJf5Do0OZf9GyA&s"
            alt=""
          />
        </div>
      </section>
      ...
      >
        <div className="featured-content">
          ...
          <div className="featured-text">
            <h2>Double Cheese and Bacon Cheeseburger</h2>
            {/* <h2>High resolution, digital capture of a double cheese cheeseburger with crispy bacon slices, American cheese, pickles, onions, tomatoes, lettuce, ketchup, and mustard, on a fresh sesame seed bun, set against a clean, white background sweep. Shot in an aspirational advertising style.</h2> */}
          </div>
        </div>
      </section>
